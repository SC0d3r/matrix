...
module.exports = function invalidityReasoner(matrix) {
  ...
  const colsShouldBeSameLength = shouldBeArray && haveSameLengthCols(matrix);
  ...
  if(!colsShouldBeSameLength) messages.push('columns in matrix do not match');
...
function haveSameLengthCols(arr) {
